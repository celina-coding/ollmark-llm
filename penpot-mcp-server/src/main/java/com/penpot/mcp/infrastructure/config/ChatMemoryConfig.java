 ...
 * - penpot.mcp.chat.memory.max-messages : Nombre max de messages en mémoire
...
public class ChatMemoryConfig {
     ...
     * Configuré via application.yml : penpot.mcp.chat.memory.max-messages
     */
    @Value("${penpot.mcp.chat.memory.max-messages:20}")
